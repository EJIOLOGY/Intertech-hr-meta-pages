        ...
        <div className="mt-10 space-y-10 leading-7 text-slate-700 sm:mt-12 sm:space-y-12">
          ...
          <section aria-labelledby="how-information-is-used">
            ...
            <ul className="mt-3 list-disc space-y-2.5 pl-5 sm:mt-4 sm:pl-6">
              ...
              <li>Connect employees with authorised HR personnel.</li>
              <li>Manage and follow up on HR escalations.</li>
              <li>Operate, secure and monitor the HR service.</li>
              <li>Investigate security, operational or service issues.</li>
              <li>
                Meet applicable legal, regulatory and organisational
                requirements.
              </li>
            </ul>
          </section>
          ...
          <section aria-labelledby="hr-escalations">
            ...
            <p className="mt-3 sm:mt-4">
              ...
              menu path used and the time of the request.
            </p>
          </section>
          ...
          <section aria-labelledby="international-processing">
            ...
            <p className="mt-3 sm:mt-4">
              ...
              apply appropriate safeguards in accordance with applicable
              data-protection requirements.
            </p>
          </section>
          ...
          <section aria-labelledby="service-design">
            ...
            <p className="mt-3 sm:mt-4">
              ...
              understanding, generative AI, large language models or a
              retrieval-augmented generation system to determine responses.
            </p>
          </section>
